...
The checked-in keytab and ccache fixtures are generated by that runtime in a
disposable `TEST.GOKRB5.LOCAL` realm. The pinned 1.22.2 source oracle remains
the reference for behavior study; it is intentionally distinct from the
1.19.2 fixture generator.
