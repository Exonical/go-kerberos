...
| GSS channel bindings (RFC 1964 / RFC 4121) | RFC 1964 MD5 encoding, RFC 4121 `0x8003` Bnd placement, matching/mismatch/absent/zero-binding tolerance, and SPNEGO/IAKERB propagation | No live gate: the installed environment lacks `python3-gssapi`; the Go suite uses MIT-derived encoding and acceptor semantics | `krb5/gssapi` unit coverage |
