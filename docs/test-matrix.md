...
| Local authorization and identity selection | Go auth_to_local, .k5login, and .k5identity tests | No live MIT CLI gate exposes an2ln/kuserok; MIT source cases are ported locally | RULE/DEFAULT translation, authoritative k5login fallback, ownership checks, and service/host/realm identity matching |
